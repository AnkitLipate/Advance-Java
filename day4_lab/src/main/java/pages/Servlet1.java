...
public class Servlet1 extends HttpServlet {
	...
	public void init() throws ServletException {
		System.out.println("in init : Servlet 1"+Thread.currentThread());
	}
	 ...
	 */
	public void destroy() {
		System.out.println("in destroy : Servlet 1"+Thread.currentThread());
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		System.out.println("in do-get : Servlet 1"+Thread.currentThread());	
