	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try (PrintWriter pw = response.getWriter()) {
			...
			if (user == null) {
				...
				// add topic dao instance under the session scope(so that the other servlets can share the same.)
				...
				// sts code : SC302 | location=topics , content-length=0, Set-cookie :
				// JSESSIONID
