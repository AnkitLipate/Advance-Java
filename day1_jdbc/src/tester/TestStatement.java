...
public class TestStatement {
	...
	public static void main(String[] args) {
		try (// establish db connection
			...
			// RST processing
			while (rst.next())
				System.out.println("User details ID " + rst.getInt(1) + " Complete Name " + rst.getString(2) + " "
						+ rst.getString(3) + " email " + rst.getString(4) + " reg amount" + rst.getDouble(6)
						+ " reged on " + rst.getDate(7));
